...
import image2 from "../assets/room/deluxe-room/2.jpg";
import image3 from "../assets/room/deluxe-room/3.jpg";
import image4 from "../assets/room/deluxe-room/4.jpg";
      ...
      <div className="room-overview">
        ...
        <div className="overview-table">
          ...
          <div className="overview-row">
            ...
            <span className="value">192 sq. feet</span>
          </div>
          <div className="overview-row">
          ...
          <div className="overview-row">
            <span className="label">Common Balcony:</span>
            <span className="value">Yes</span>
          </div>
          <div className="overview-row">

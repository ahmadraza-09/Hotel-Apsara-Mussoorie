      ...
      case 'Quality':
        return (
          <div className="our-resort-value-right-container-content">
            ...
            <br />
            <p>
              Hotel Apsara Mussoorie is synonymous with exceptional quality, offering guests a blend
              of comfort, elegance, and impeccable service amidst the serene beauty of mussoorie.
              Nestled amidst lush aroma park, our hotel promises a memorable retreat with
              ...
              its finest at Hotel Apsara Mussoorie.
            </p>
          </div>
        );
      case 'Our Vision':
        return (
          <div className="our-resort-value-right-container-content">
            ...
            <br />
            <p>
              The vision of Hotel Apsara Mussoorie is to provide an unparalleled hospitality experience
              amidst the natural beauty of mussoorie. We aim to be a beacon of luxury and serenity,
      ...
      case 'Success':
        return (
          <div className="our-resort-value-right-container-content">
            ...
            <br />
            <p>
              Success at Hotel Apsara Mussoorie is defined by our ability to exceed guest expectations,
